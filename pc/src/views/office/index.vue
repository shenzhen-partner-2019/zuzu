<template>
  <div class="office-page">
    <!--面包组件-->
    <CrumbsCompent></CrumbsCompent>
    <!--选择过滤-->
    <SelectFiller></SelectFiller>
    <div class="wrap share-list clear">
      <div class="list-left">
        <div class="tab-nav">
          ...
          <span class="total">共有<strong>{{neckwork}}</strong>个网点满足您的需求</span>
        </div>
        <div class="list">
          <div class="houseResource-warpper">
                            ...
                            <a v-for="(item,index) in houseResourceData" :key="index" >
                                ...
                                <div class="list-content fl">
                                    ...
                                    <div class="list-price">
                                        ...
                                        <div class="TagCollection" v-if="item.shoucang">
...
export default {
  ...
  computed:{
    neckwork(){
      return this.houseResourceData.length >0?this.pager.total:0
    }
  },
  created() {
  ...
  methods: {
    ...
    async getAllHouseList(){
      try {
          let allHouse = await this.getHouseList();
          this.pager.total = allHouse.total
          this.houseResourceData = allHouse.data
          console.log('allHouse',this.houseResourceData)
      } catch (error) {
        //  console.log(error)
      }
    },
    //详情页
     goHouseResourceDetail(id){
          console.log(id)
          this.$router.push({path:'/zuzu/office-detail',query: {id:id}})
      },
    //分页
    async onPageIndexChange(index) {
      console.log('分页',index)
      let params = {
        page: this.pager.pageIndex
      }
      let allHouse = await this.getHouseList(params);
      this.pager.total = allHouse.total
      this.houseResourceData = allHouse.data
    },
    ...mapActions([
                ...
                a{
                    ...
                    .imgbox {
                        ...
                        .video {
                            ...
                            width: 40px;
                            height: 26px;
                            background: url(../../../public/img/video.png) no-repeat right bottom;
                            font-size: 0;
                        }
                    }
                    .list-content {
